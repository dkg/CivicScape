...
print("======blob=====")
print(args[7])
blob = as.integer(args[7])


#load training data
print("loading training data...")
trainingData = read.csv(paste(trainingDataDir, "/crime_data_blob_", blob, ".assault.",indexOfBaggedSamples,".binned.csv",sep=""))
trainingData = data.frame(trainingData)
print("Done.")

#Prepare model formula
crimeType = trainingData$assault_count
...
print("Saving model....")
saveRDS(ir.nn, file = paste(modelDir,"/NNmodel_NOWEATHER_",indexOfBaggedSamples,".rds",sep = ""))
